...
namespace FPLSP_TypingContest.Server.API.Controllers
{
    ...
    public class RoundsController : ControllerBase
    {
        ...
        [HttpGet("GetByContest/{idContest}")]
        public async Task<IActionResult> GetByIdContest(string idContest)
        {
            return Ok(await _roundService.GetByIdContestAsync(idContest));
        }
        [HttpPost("Add")]
