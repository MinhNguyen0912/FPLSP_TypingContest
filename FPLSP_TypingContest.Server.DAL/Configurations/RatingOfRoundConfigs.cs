...
{
    public partial class RatingOfRoundConfigs : IEntityTypeConfiguration<RatingOfRound>
    {
        public void Configure(EntityTypeBuilder<RatingOfRound> builder)
        {
            builder.ToTable("RatingOfRound");
            builder.HasKey(c => c.IdParticipant);
